...
@Repository
public class RailwayCarriageRepositoryImpl extends BaseRepo<RailwayCarriage> implements RailwayCarriageRepository {
...
//    private BaseRailwayCarriageRepository baseRailwayCarriageRepository;
    ...
    public RailwayCarriageRepositoryImpl() {
        super(RailwayCarriage.class);
    }
